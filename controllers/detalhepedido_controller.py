...
def criar_detalhe_pedidos():
    ...
    novo_detalhe_pedido = DetalhePedido(dp_quantidade=detalhepedido['dp_quantidade'], dp_preco=detalhepedido['dp_preco'], dp_desconto=detalhepedido['dp_desconto'], dp_pedido_id=detalhepedido['dp_pedido_id'], dp_produto_id=detalhepedido['dp_produto_id'])
